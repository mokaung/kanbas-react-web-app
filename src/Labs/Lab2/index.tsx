...
export default function Lab2() {
  return (
    <div className="container" id="wd-lab2">
      ...
      <div className="foreground-colors">
          <ForegroundColors />
        </div>
        ...
        <div className="react-icons-sampler">
          <ReactIconsSampler />
        </div>
        <div className="bootstrap-grids">
          <BootstrapGrids />
        </div>
        <div className="screen-size-label">
          <ScreenSizeLabel />
        </div>
        <div className="bootstrap-tables">
          <BootstrapTables />
        </div>
        <div className="bootstrap-lists">
          <BootstrapLists />
        </div>
        <div className="bootstrap-forms">
          <BootstrapForms />
        </div>
